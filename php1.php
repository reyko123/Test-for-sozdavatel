...
class php1
{
    ...
    private $profit; // профит, сколько получит
    private $summ; // сумма вклада
    private $i; // годовая ставка по депозиту
    private $months;  // срок депозита (количество месяцев)
    private $k; // число месяцев в году
